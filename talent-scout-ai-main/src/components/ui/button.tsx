  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-primary-foreground shadow-elevated hover:shadow-glow hover:scale-105 transform",
        coral: "gradient-secondary text-secondary-foreground shadow-elevated hover:shadow-glow hover:scale-105 transform",
        glass: "glass text-foreground hover:bg-card/90 border border-border/50",
        accept: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-glow",
